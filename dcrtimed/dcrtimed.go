...
// Proxy methods for API handlers
...
// API v2 Handlers
//
// Status, timestamp and verify calls didn't change behaviour on version two.
// Therefore, their call is handled by the version one handlers.
